...
const displayMovents = movements => {
...
//   const arrofdogs = [...dogsJuliaCorrected, ...dogsKate];
//  !  const dogs = dogsJuliaCorrected.concat(dogsKate);
//   arrofdogs.forEach((dogAge, i) => {
//     const ageTest =
//       dogAge >= 3 ? `an adult, and is ${dogAge} years old` : 'still a puppy 🐶';
//     console.log(`Dog number ${i + 1} is ${ageTest}`);
//   });
// };
...
//     adults.reduce((acc, cur) => acc + cur) / adults.length
//   );
